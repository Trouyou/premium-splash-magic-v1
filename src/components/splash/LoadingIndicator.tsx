...
const LoadingIndicator = ({ isVisible }: LoadingIndicatorProps) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 20 }}
      className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/96 px-6 py-4 rounded-lg shadow-md z-[9999] font-playfair text-lg flex items-center"
    >

...
export const kitchenEquipment: Equipment[] = [
  ...
  { 
    id: 'thermomix', 
    name: 'Thermomix', 
    icon: <CookingPot stroke={1.5} size={32} />, 
    category: 'Appareils électriques' 
  },
  { 
    id: 'blender', 
    name: 'Blender / Mixeur', 
    icon: <Cherry stroke={1.5} size={32} />, 
    category: 'Appareils électriques' 
  },
  { 
    id: 'robot', 
    name: 'Robot pâtissier', 
    icon: <ChefHat stroke={1.5} size={32} />, 
    category: 'Appareils électriques' 
  },
  { 
    id: 'airfryer', 
  ...
  { 
    ...
    icon: <Microwave stroke={1.5} size={32} />, 
    category: 'Appareils électriques' 
  },
  ...
  { 
    ...
    icon: <UtensilsCrossed stroke={1.5} size={32} />, 
    category: 'Ustensiles essentiels' 
  },
  { 
    id: 'cuttingboard', 
    name: 'Planche à découper', 
    icon: <ScrollText stroke={1.5} size={32} />, 
    category: 'Ustensiles essentiels' 
  },
  { 
    id: 'whisk', 
  ...
  { 
    id: 'spatula', 
    name: 'Spatule', 
    icon: <Utensils stroke={1.5} size={32} />, 
    category: 'Ustensiles essentiels' 
  },
  { 
    id: 'woodenspoons', 
  ...
  { 
    ...
    icon: <Scale stroke={1.5} size={32} />, 
    category: 'Outils de mesure et préparation' 
  },
  { 
    id: 'measuringcup', 
    name: 'Verre doseur', 
    icon: <Gauge stroke={1.5} size={32} />, 
    category: 'Outils de mesure et préparation' 
  },
  { 
    id: 'mixingbowls', 
  ...
  { 
    ...
    icon: <Thermometer stroke={1.5} size={32} />, 
    category: 'Outils de mesure et préparation' 
  },
];
